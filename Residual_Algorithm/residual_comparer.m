...
for pt=60 %[37 48 59 60 65 66 67]
    pt
    pt_id = T{pt,1}{1}
    
    if isfile(strcat('../Cluster/Residual_Algorithm/MatFiles/',pt_id,'_val1_WS.mat'))
        load(strcat('../Cluster/Residual_Algorithm/MatFiles/',pt_id,'_val1_WS.mat'))

        error  = zeros(5,2);


        for k = 1:8%:3 %reducing rest before 
            i=3;
        ...
        %% plots
            ...
            if i == 4
                ...
                load(strcat('Valsalva/nomHR_residuals/',pt_id,'_Val1_',num2str(30 - 5*num),'_',num2str(k),'_nomHR.mat'))
                load(strcat('Valsalva/optHR_residuals/',pt_id,'_Val1_',num2str(30 - 5*num),'_optHR.mat'))
            else
                load(strcat('Valsalva/nomHR_residuals/',pt_id,'_Val1_',num2str(30 - 5*i),'_nomHR.mat'))
                load(strcat('Valsalva/optHR_residuals/',pt_id,'_Val1_',num2str(30 - 5*i),'_',num2str(k),'_optHR.mat'))
            end
    ...
    %         yyaxis right 
            ...
            fig_name = strcat('FIG_',pt_id,'_',num2str(30 - 5*i));
