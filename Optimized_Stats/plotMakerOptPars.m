...
saveas(figure(1),'Figures/silhouette.png')
...
% saveas(figure(2),'Figures/boxplot.eps')
...
% set(gca,'fontsize',32)
% ylabel('Relative Parameters')
% saveas(figure(1),'Figures/boxplot.eps')
...
scatter3(cluster2(:,1),cluster2(:,2),cluster2(:,3),'','r')
saveas(figure(11),'Figures/PCAcluster.png')
saveas(figure(11),'Figures/PCAcluster.eps')
...
%saveas(figure(4),'Figures/biplot.png')
%saveas(figure(4),'Figures/biplot.eps')
